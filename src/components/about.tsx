...
export function About() {
    return (
        <section id="about" className="py-32 md:py-64 px-6 md:px-12 lg:px-24 border-t border-foreground/5 relative overflow-hidden">
            {/* Background elements */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-end">
                    ...
                    <div className="lg:col-span-5 space-y-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <h3 className="text-4xl md:text-5xl font-serif italic">L&apos;approche technique.</h3>
                            <p className="text-base text-foreground/60 leading-relaxed font-light max-w-md">
                    ...
                    <div className="lg:col-span-7 space-y-24">
                        ...
                        >
                            <h2 className="text-2xl md:text-4xl lg:text-5xl leading-tight font-light tracking-tight">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-start">
                            <div className="space-y-12 pt-8 border-t border-foreground/10">
